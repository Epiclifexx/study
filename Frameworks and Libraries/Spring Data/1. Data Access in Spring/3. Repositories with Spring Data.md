...
And, because the ROOM_ID was using like, a key from other table, I thought that maybe, the right way to represent it in Java, was using a "Room" Entity object. But at the end, I just used a long type to represent the Id.
